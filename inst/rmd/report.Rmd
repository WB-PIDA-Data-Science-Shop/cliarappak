...
```{r}
knitr::include_graphics(system.file("app/www/cliar.png", package = "cliarappak"))
```
...
knitr::include_graphics(system.file("app/www/new_families.png", package = "cliarappak"))
```
...
params$family_data %>%
  ...
  static_plot(
    ...
    report = TRUE,
    db_variables = params$db_variables, family_order = params$family_order,
    ctf_long = params$ctf_long
  )
...
```{r,fig.height= 14,results = "asis"}
  ...
  static_plot_dyn(
    ...
    threshold = params$threshold,
    db_variables = params$db_variables, ctf_long_dyn = params$ctf_long_dyn
  )
